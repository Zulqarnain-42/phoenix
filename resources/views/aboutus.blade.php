        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="text-center">
                    <h2 class="ui-title-block ui-title-block_weight_normal">We
                        <span class="text-primary"> Create Events</span> That Lasts
                    </h2>
                    ...
                    <div class="entry-main">
                        <div class="entry-header">
                            ...
                            <h2 class="entry-title entry-title_spacing ui-title-inner">
                                <a href="{{route('services')}}">Our Vision</a>
                            </h2>
                        </div>
                ...
                <section class="clearfix b-post-sm b-post-sm-1 b-post-sm-1_align_center">
                    ...
                    <div class="entry-main">
                        <div class="entry-header">
                            <div class="ui-decor-2 ui-decor-2_vert bg-primary"></div>
                            <h2 class="entry-title entry-title_spacing ui-title-inner">
                                <a href="{{route('services')}}">Our Approach</a>
                            </h2>
                        </div>
                        <div class="entry-content">
                ...
                <section class="clearfix b-post-sm b-post-sm-1 b-post-sm-1_align_center">
                    ...
                    <div class="entry-main">
                        <div class="entry-header">
                            <div class="ui-decor-2 ui-decor-2_vert bg-primary"></div>
                            <h2 class="entry-title entry-title_spacing ui-title-inner">
                                <a href="{{route('services')}}">Our Goals</a>
                            </h2>
                        </div>
                        <div class="entry-content">
...
<div class="block-table block-table-lg">
    <div class="block-table__cell col-lg-6">
        <section class="section-type-2 bg-grey">
            ...
            <h2 class="ui-title-block">Why Choose<span class="text-primary"> Phoenix Events</span></h2>
            <div class="ui-subtitle-block">Corem ipsum dolor sit amet elit sed do eiusmod tempor incididunt labore.</div>
            <section class="b-advantages-2 b-advantages-2_mod-a">
            ...
            <section class="b-advantages-2 b-advantages-2_mod-a">
                <i class="b-advantages-2__icon flaticon-firework"></i>
                <div class="b-advantages-2__inner">
            ...
            <section class="b-advantages-2 b-advantages-2_mod-a">
                <i class="b-advantages-2__icon flaticon-technology"></i>
                <div class="b-advantages-2__inner">
    ...
    <div class="block-table__cell col-lg-6">
        <img src="assets/media/content/960x783/1.jpg" alt="foto">
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="text-center">
                    <h2 class="ui-title-block"><span class="text-primary"> Phoenix Events</span> Team Members</h2>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <h2 class="ui-title-block">
                    <span class="text-primary"> Phoenix Events</span> Skills
                </h2>
                ...
                <div class="progress-block-group">
                    <div class="progress-block">
                        ...
                        <div class="progress progress-w-number">
                            <div style="width: 80%" class="progress-bar bg-primary">
                                <span class="progress-bar__number">80%</span>
                            </div>
                        </div>
                    </div>
                    <div class="progress-block">
                        ...
                        <div class="progress progress-w-number">
                            <div style="width: 90%" class="progress-bar bg-primary">
                                <span class="progress-bar__number">90%</span>
                            </div>
                        </div>
                    </div>
                    <div class="progress-block">
                        ...
                        <div class="progress progress-w-number">
                            <div style="width: 55%" class="progress-bar bg-primary">
                                <span class="progress-bar__number">55%</span>
                            </div>
                        </div>
                    </div>
                    <div class="progress-block">
                        ...
                        <div class="progress progress-w-number">
                            <div style="width: 65%" class="progress-bar bg-primary">
                                <span class="progress-bar__number">65%</span>
                            </div>
                        </div>
                    </div>
                    <div class="progress-block">
                        ...
                        <div class="progress progress-w-number">
                            <div style="width: 85%" class="progress-bar bg-primary">
                                <span class="progress-bar__number">85%</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="b-advertisement area-bg area-bg_dark area-bg_op_70 parallax">
    <div class="area-bg__inner">
        <div class="b-advertisement__label bg-primary">Celebrate with<strong> Phoenix Events</strong></div>

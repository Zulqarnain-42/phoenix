        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-0 col-md-6 col-md-offset-3">
                <div data-stellar-background-ratio="0.4" class="b-contact stellar section-texture section-texture_grey section-radius">
                    ...
                    <div class="b-contact__info">inform@Phoenix Events.com</div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <ul class="social-net list-inline">
                    ...
                    <li class="social-net__item">
                        <a href="skype.com" class="social-net__link text-primary_h">
                            <i class="icon fa fa-skype"></i>
                        </a>
                    </li>
                    <li class="social-net__item">
                        <a href="behance.com" class="social-net__link text-primary_h">
                            <i class="icon fa fa-behance"></i>
                        </a>
                    </li>
                    <li class="social-net__item">
                        <a href="vimeo.com" class="social-net__link text-primary_h">
